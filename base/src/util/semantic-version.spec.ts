...
describe('SemanticVersion', () => {
  describe('constructor', () => {
    ...
    it('should parse major.minor without patch', () => {
    ...
    it('should parse version with pre-release identifiers', () => {
    ...
    it('should parse version with both identifiers and build', () => {
    ...
    it('should set identifiers to null when not present', () => {
      const v = new SemanticVersion('1.2.3');
      expect(v.identifiers).to.be.null;
    });

    it('should set build to null when not present', () => {
      const v = new SemanticVersion('1.2.3');
      expect(v.build).to.be.null;
    });

    it('should throw on invalid version string', () => {
      expect(() => new SemanticVersion('invalid')).to.throw('ZWED5043E');
    });

    it('should throw on empty string', () => {
      expect(() => new SemanticVersion('')).to.throw('ZWED5043E');
    });

    it('should throw on single number', () => {
      expect(() => new SemanticVersion('1')).to.throw('ZWED5043E');
    });

    it('should throw on version with letters in numbers', () => {
      expect(() => new SemanticVersion('1.a.3')).to.throw('ZWED5043E');
    });

    it('should handle numeric pre-release identifiers', () => {
      const v = new SemanticVersion('1.0.0-1');
      expect(v.identifiers).to.equal('1');
    });

    it('should handle hyphenated pre-release identifiers', () => {
